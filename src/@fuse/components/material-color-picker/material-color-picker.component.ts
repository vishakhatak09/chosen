import { Component, EventEmitter, forwardRef, Input, Output, ViewEncapsulation, ViewChild } from '@angular/core';
...
export class FuseMaterialColorPickerComponent implements ControlValueAccessor {
    ...
    @ViewChild('menuTriggerButton', {static: false, read: MatMenuTrigger}) menuTriggerButton: MatMenuTrigger;
    ...
    selectHue(event, hue): void {
        ...
        // Update the selected color
        this.updateSelectedColor();
        if ( this.menuTriggerButton && this.menuTriggerButton.menuOpen === true ) {
