...
<div style="margin-top: 20px;">
    <table cellspacing="0" cellpadding="0" style="font-family: sans-serif; width: 700px; margin: auto;color: #444444;">
        <tr>
        ...
        <tr>
            <td style="background: #eaeaea;padding: 0 30px;">
                <table cellspacing="0" cellpadding="0" style="width: 100%">
                    <tr>
                        <td style="font-size: 12px; padding: 5px 5px;">
                            <div style="white-space: nowrap;">
                                <img style="width: 14px;display: inline-block;vertical-align: middle;"
                        ...
                        <td style="font-size: 12px; padding: 5px 5px;">
                            <div style="white-space: nowrap;">
                                ...
                                <span
                                    style="margin-left: 3px;display: inline-block;vertical-align: middle;">john.doe.skype.in</span>
                            </div>
                        </td>
                        <td style="font-size: 12px; padding: 5px 5px;">
                            <div style="white-space: nowrap;">
                                <img style="width: 14px;display: inline-block;vertical-align: middle;"
                                    src="assets/icons/template-icons/facebook.svg" alt="">
                                <span
                                    style="margin-left: 3px;display: inline-block;vertical-align: middle;">facebook.com/john.doe</span>
                            </div>
                        </td>
                        <td style="font-size: 12px; padding: 5px 5px;">
                            <div style="white-space: nowrap;">
                                <img style="width: 14px;display: inline-block;vertical-align: middle;"
                                    src="assets/icons/template-icons/website.svg" alt="">
                                <span
                                    style="margin-left: 3px;display: inline-block;vertical-align: middle;">www.website.com</span>
                            </div>
                        </td>
                    </tr>
                </table>
